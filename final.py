...
class Konsultasi:
    def __init__(self, root):
        ...
        self.selected_treatments = []  # Untuk menyimpan perawatan yang dipilih
        self.selected_additional_treatments = []  # Untuk menyimpan perawatan tambahan yang dipilih
        self.customer_name = ""

        # Muat pelanggan terdaftar
        try:
    ...
    def page_welcome(self):
        ...
        tk.Button(self.root, text="Login", command=self.page_login).pack(pady=20)
        tk.Button(self.root, text="Registrasi", command=self.page_registration).pack(pady=20)
    ...
    def page_registration(self):
        ...
        tk.Button(self.root, text="Registrasi", command=lambda: self.register_user(name_entry.get(), password_entry.get())).pack(pady=20)
        tk.Button(self.root, text="Kembali", command=self.page_welcome).pack(pady=10)
    ...
    def page_login(self):
        ...
        tk.Button(self.root, text="Login", command=lambda: self.login_user(name_entry.get(), password_entry.get())).pack(pady=20)
        tk.Button(self.root, text="Kembali", command=self.page_welcome).pack(pady=10)
    ...
    def page_skin_type(self):
        ...
        tk.Button(self.root, text="Selanjutnya", command=handle_skin_type_selection).pack(pady=20)
        tk.Button(self.root, text="Kembali", command=self.page_login).pack(pady=10)
    ...
    def page_face_problem(self):
        ...
        tk.Button(self.root, text="Selanjutnya", command=handle_face_problem_selection).pack(pady=20)
        tk.Button(self.root, text="Kembali", command=self.page_skin_type).pack(pady=10)

    def page_treatments(self):
        self.clear_window()
        tk.Label(self.root, text="Pilih Perawatan Wajah Anda", font=("Arial", 14)).pack(pady=20)

        # Dapatkan perawatan yang direkomendasikan berdasarkan jenis kulit dan masalah wajah yang dipilih
        ...
        tk.Button(self.root, text="Selanjutnya", command=handle_treatments_selection).pack(pady=20)
        # Tombol "Kembali" untuk kembali ke halaman sebelumnya
        tk.Button(self.root, text="Kembali", command=self.page_face_problem).pack(pady=10)
    ...
    def page_additional_treatments(self):
        ...
        tk.Button(self.root, text="Selanjutnya", command=self.page_schedule).pack(pady=20)
        tk.Button(self.root, text="Kembali", command=self.page_treatments).pack(pady=10)
    ...
    def page_schedule(self):
        ...
        tk.Button(self.root, text="Selanjutnya", command=handle_schedule_selection).pack(pady=20)
        tk.Button(self.root, text="Kembali", command=self.page_additional_treatments).pack(pady=10)
    ...
    def page_time_selection(self):
        ...
        tk.Button(self.root, text="Selanjutnya", command=handle_time_selection).pack(pady=20)
        tk.Button(self.root, text="Kembali", command=self.page_schedule).pack(pady=10)
    ...
    def page_summary(self):
        ...
        tk.Button(self.root, text="Selesai", command=finish_consultation).pack(pady=20)
